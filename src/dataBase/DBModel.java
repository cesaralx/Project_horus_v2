...
//            pst = con.mkDataBase().prepareStatement(" use "+db);
//            pst.execute();
//            
//            pst = con.mkDataBase().prepareStatement("if not exists (select * from sysobjects where name ='usuario' and xtype='U') \n CREATE TABLE 'usuario' (\n"
...
//            pst.execute();
//            pst = con.mkDataBase().prepareStatement("if not exists (select * from sysobjects where name='userpermission' and xtype='U') \n CREATE TABLE if not exists "+db+".`UserPermission` (\n"
//                    + "  `Id` int(11) NOT NULL AUTO_INCREMENT,\n"
...
//                    + "  UNIQUE INDEX `Id` (`Id` ASC));");
//            pst.execute();
//            pst = con.mkDataBase().prepareStatement("if not exists (select * from sysobjects where name='empresa' and xtype='U') \n CREATE TABLE if not exists "+db+".`Organize` (\n"
//                    + "  `Id` int(1) NOT NULL ,\n"
...
//            pst.execute();
//
//            pst = con.mkDataBase().prepareStatement("if not exists (select * from sysobjects where name='proveedor' and xtype='U') \n CREATE TABLE if not exists "+db+".`Supplyer` (\n"
//                    + "  `Id` int(11) NOT NULL AUTO_INCREMENT,\n"
...
//            pst.execute();
//
//            pst = con.mkDataBase().prepareStatement("if not exists (select * from sysobjects where name='marcas' and xtype='U') \n CREATE TABLE if not exists "+db+".`Brands` (\n"
//                    + "  `Id` int(11) NOT NULL AUTO_INCREMENT,\n"
...
//            pst.execute();
//
//            pst = con.mkDataBase().prepareStatement("if not exists (select * from sysobjects where name='categoria' and xtype='U') \n CREATE TABLE if not exists "+db+".`Catagory` (\n"
//                    + "  `Id` int(11) NOT NULL AUTO_INCREMENT,\n"
...
//
//            pst.execute();
//            pst = con.mkDataBase().prepareStatement("if not exists (select * from sysobjects where name='unit' and xtype='U') \n CREATE TABLE if not exists "+db+".`Unit` (\n"
//                    + "  `Id` int(11) NOT NULL AUTO_INCREMENT,\n"
...
//            pst.execute();
//
//            pst = con.mkDataBase().prepareStatement("if not exists (select * from sysobjects where name='devolucion' and xtype='U') \n CREATE TABLE if not exists "+db+".`RMA` (\n"
//                    + "  `Id` int(11) NOT NULL AUTO_INCREMENT,\n"
...
//
//            pst.execute();
//            pst = con.mkDataBase().prepareStatement("if not exists (select * from sysobjects where name='productos' and xtype='U') \n CREATE TABLE IF NOT EXISTS "+db+".`Products` (\n"
//                    + "  `Id` int(11) NOT NULL AUTO_INCREMENT,\n"
...
//            pst.execute();
//
//            pst = con.mkDataBase().prepareStatement("if not exists (select * from sysobjects where name='cliente' and xtype='U') \n CREATE TABLE IF NOT EXISTS "+db+".`Customer` (\n"
//                    + "  `Id` int(11) NOT NULL AUTO_INCREMENT,\n"
...
//            pst.execute();
//
//            pst = con.mkDataBase().prepareStatement("if not exists (select * from sysobjects where name='venta' and xtype='U') \n CREATE TABLE IF NOT EXISTS "+db+".`Sell` (\n"
//                    + "  `Id` int(11) NOT NULL AUTO_INCREMENT,\n"
