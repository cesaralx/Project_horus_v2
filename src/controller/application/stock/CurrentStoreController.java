...
showDetails();
    ...
    private void cbSoteViewSupplyerOnClick(MouseEvent event) {
        ...
        cbSoteViewBrands.setPromptText("Selecciona marca");
        cbSoteViewCatagory.setPromptText("Selecciona categoria");
        try {
    ...
    private void btnAddNewOnAction(ActionEvent event) {
        ...
        try {
            ...
            addProductController.lblHeader.setText("Agregar producto");
